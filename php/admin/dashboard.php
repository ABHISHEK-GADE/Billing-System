        ...
        <main class="dashboard-content">
            ...
            <div class="dashboard-overview">
                <div class="dashboard-card">
                    <h3>Total Clients</h3>
                    <a href="manage_users.php"><?= htmlspecialchars($totalUsers) ?></a>
                </div>
                <div class="dashboard-card">
                    <h3>Total Products</h3>
                    <a href="manage_products.php"><?= htmlspecialchars($totalProducts) ?></a>
                </div>
                <div class="dashboard-card">
                    <h3>Total Bills</h3>
                    <a href="manage_bills.php"><?= htmlspecialchars($totalBills) ?></a>
                </div>
                <div class="dashboard-card">
                    <h3>Pending Requests</h3>
                    <a href="manage_requests.php"><?= htmlspecialchars($pendingRequests) ?></a>
                </div>
            </div>
        </main>
    </div>
